...
\DataTypeTok{TypeError}\NormalTok{: Arguments to }\KeywordTok{path}\NormalTok{.}\FunctionTok{join} \NormalTok{must be strings}
\end{Highlighting}
\end{Shaded}
...
\subsection{path.isAbsolute(path)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'/foo/bar'}\NormalTok{) }\CommentTok{// true}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'/baz/..'}\NormalTok{)  }\CommentTok{// true}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'qux/'}\NormalTok{)     }\CommentTok{// false}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'.'}\NormalTok{)        }\CommentTok{// false}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'//server'}\NormalTok{)  }\CommentTok{// true}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'C:/foo/..'}\NormalTok{) }\CommentTok{// true}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'bar\textbackslash{}\textbackslash{}baz'}\NormalTok{)   }\CommentTok{// false}
\KeywordTok{path}\NormalTok{.}\FunctionTok{isAbsolute}\NormalTok{(}\CharTok{'.'}\NormalTok{)         }\CommentTok{// false}
\end{Highlighting}
\end{Shaded}
