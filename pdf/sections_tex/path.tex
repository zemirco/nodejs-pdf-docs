...
\OtherTok{process}\NormalTok{.}\OtherTok{env}\NormalTok{.}\OtherTok{PATH}\NormalTok{.}\FunctionTok{split}\NormalTok{(}\OtherTok{path}\NormalTok{.}\FunctionTok{delimiter}\NormalTok{)}
\CommentTok{// returns}
\NormalTok{[}\StringTok{'C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Windows}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{system32'}\NormalTok{, }\StringTok{'C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Windows'}\NormalTok{, }\StringTok{'C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Program Files}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{nodejs}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{'}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{// returns}
\NormalTok{\{}
    \DataTypeTok{root }\NormalTok{: }\StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{"}\NormalTok{,}
    \DataTypeTok{dir }\NormalTok{: }\StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{path}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{dir"}\NormalTok{,}
