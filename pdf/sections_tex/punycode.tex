...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{punycode.ucs2}\NormalTok{.}\FunctionTok{decode}\NormalTok{(}\CharTok{'abc'}\NormalTok{); }\CommentTok{// [0x61, 0x62, 0x63]}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{punycode.ucs2}\NormalTok{.}\FunctionTok{encode}\NormalTok{([}\DecValTok{0x61}\NormalTok{, }\DecValTok{0x62}\NormalTok{, }\DecValTok{0x63}\NormalTok{]); }\CommentTok{// 'abc'}
