...
\NormalTok{setTimeout(}\KeywordTok{function}\NormalTok{() \{}
  ...
  \KeywordTok{console}\NormalTok{.}\FunctionTok{log}\NormalTok{(}\CharTok{'benchmark took %d seconds and %d nanoseconds'}\NormalTok{,}
              \NormalTok{diff[}\DecValTok{0}\NormalTok{], diff[}\DecValTok{1}\NormalTok{]);}
