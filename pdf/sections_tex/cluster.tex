...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{% NODE_DEBUG=cluster node }\KeywordTok{server}\NormalTok{.}\FunctionTok{js}
\NormalTok{23521,Master Worker }\DecValTok{23524} \NormalTok{online}
...
\subsection{cluster.schedulingPolicy}
...
\KeywordTok{worker}\NormalTok{.}\FunctionTok{kill}\NormalTok{();}
\end{Highlighting}
\end{Shaded}
