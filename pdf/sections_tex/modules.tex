...
\DecValTok{3}\NormalTok{. }\FunctionTok{If} \OtherTok{X}\NormalTok{.}\FunctionTok{node} \FunctionTok{is} \FunctionTok{a} \FunctionTok{file}\NormalTok{, load }\OtherTok{X}\NormalTok{.}\FunctionTok{node} \FunctionTok{as} \FunctionTok{binary} \OtherTok{addon}\NormalTok{.  }\FunctionTok{STOP}
