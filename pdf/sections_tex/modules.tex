...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{function} \NormalTok{MyConstructor (opts) \{}
  \CommentTok{//...}
\NormalTok{\}}

\CommentTok{// BROKEN: Does not modify exports}
\NormalTok{exports = MyConstructor;}

\CommentTok{// exports the constructor properly}
\KeywordTok{module}\NormalTok{.}\FunctionTok{exports} \NormalTok{= MyConstructor;}
\end{Highlighting}
\end{Shaded}
