...
\paragraph{Event: `close'}\label{event-close}
...
\OtherTok{http}\NormalTok{.}\FunctionTok{createServer}\NormalTok{(}\KeywordTok{function} \NormalTok{(req, res) \{}
  \OtherTok{res}\NormalTok{.}\FunctionTok{write}\NormalTok{(}\StringTok{'hello, '}\NormalTok{);}
  \OtherTok{res}\NormalTok{.}\FunctionTok{end}\NormalTok{(}\StringTok{'world!'}\NormalTok{);}
...
\paragraph{Event: `unpipe'}\label{event-unpipe}
...
\KeywordTok{function} \FunctionTok{JSONParseStream}\NormalTok{(options) \{}
  \KeywordTok{if} \NormalTok{(!(}\KeywordTok{this} \KeywordTok{instanceof} \NormalTok{JSONParseStream))}
    \KeywordTok{return} \KeywordTok{new} \FunctionTok{JSONParseStream}\NormalTok{(options);}

  \OtherTok{Transform}\NormalTok{.}\FunctionTok{call}\NormalTok{(}\KeywordTok{this}\NormalTok{, options);}
  \KeywordTok{this}\NormalTok{.}\OtherTok{_writableState}\NormalTok{.}\FunctionTok{objectMode} \NormalTok{= }\KeywordTok{false}\NormalTok{;}
  \KeywordTok{this}\NormalTok{.}\OtherTok{_readableState}\NormalTok{.}\FunctionTok{objectMode} \NormalTok{= }\KeywordTok{true}\NormalTok{;}
