...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{buf = }\KeywordTok{new} \FunctionTok{Buffer}\NormalTok{(}\DecValTok{10}\NormalTok{);}
\OtherTok{buf}\NormalTok{.}\FunctionTok{write}\NormalTok{(}\StringTok{"abcdefghj"}\NormalTok{, }\DecValTok{0}\NormalTok{, }\StringTok{"ascii"}\NormalTok{);}
\OtherTok{console}\NormalTok{.}\FunctionTok{log}\NormalTok{(}\OtherTok{buf}\NormalTok{.}\FunctionTok{length}\NormalTok{); }\CommentTok{// 10}
\NormalTok{buf = }\OtherTok{buf}\NormalTok{.}\FunctionTok{slice}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{);}
\OtherTok{console}\NormalTok{.}\FunctionTok{log}\NormalTok{(}\OtherTok{buf}\NormalTok{.}\FunctionTok{length}\NormalTok{); }\CommentTok{// 5}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var} \NormalTok{b = }\KeywordTok{new} \FunctionTok{Buffer}\NormalTok{(}\DecValTok{6}\NormalTok{);}
\OtherTok{b}\NormalTok{.}\FunctionTok{writeUIntBE}\NormalTok{(}\BaseNTok{0x1234567890ab}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{6}\NormalTok{);}
\CommentTok{// <Buffer 12 34 56 78 90 ab>}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{var} \NormalTok{b = }\KeywordTok{new} \FunctionTok{Buffer}\NormalTok{(}\DecValTok{6}\NormalTok{);}
\OtherTok{b}\NormalTok{.}\FunctionTok{writeUint16LE}\NormalTok{(}\BaseNTok{0x90ab}\NormalTok{, }\DecValTok{0}\NormalTok{);}
\OtherTok{b}\NormalTok{.}\FunctionTok{writeUInt32LE}\NormalTok{(}\BaseNTok{0x12345678}\NormalTok{, }\DecValTok{2}\NormalTok{);}
\OtherTok{b}\NormalTok{.}\FunctionTok{readUIntLE}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{6}\NormalTok{).}\FunctionTok{toString}\NormalTok{(}\DecValTok{16}\NormalTok{);  }\CommentTok{// Specify 6 bytes (48 bits)}
\CommentTok{// output: '1234567890ab'}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{buf = }\KeywordTok{new} \FunctionTok{Buffer}\NormalTok{(}\DecValTok{26}\NormalTok{);}
\KeywordTok{for} \NormalTok{(}\KeywordTok{var} \NormalTok{i = }\DecValTok{0} \NormalTok{; i < }\DecValTok{26} \NormalTok{; i++) \{}
  \NormalTok{buf[i] = i + }\DecValTok{97}\NormalTok{; }\CommentTok{// 97 is ASCII a}
\NormalTok{\}}
\OtherTok{buf}\NormalTok{.}\FunctionTok{toString}\NormalTok{(}\StringTok{'ascii'}\NormalTok{); }\CommentTok{// outputs: abcdefghijklmnopqrstuvwxyz}
\OtherTok{buf}\NormalTok{.}\FunctionTok{toString}\NormalTok{(}\StringTok{'ascii'}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{); }\CommentTok{// outputs: abcde}
\OtherTok{buf}\NormalTok{.}\FunctionTok{toString}\NormalTok{(}\StringTok{'utf8'}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{); }\CommentTok{// outputs: abcde}
\OtherTok{buf}\NormalTok{.}\FunctionTok{toString}\NormalTok{(}\KeywordTok{undefined}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{); }\CommentTok{// encoding defaults to 'utf8', outputs abcde}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{buf}\NormalTok{.}\FunctionTok{copy}\NormalTok{(buf, }\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{10}\NormalTok{);}
\OtherTok{console}\NormalTok{.}\FunctionTok{log}\NormalTok{(}\OtherTok{buf}\NormalTok{.}\FunctionTok{toString}\NormalTok{());}

\CommentTok{// efghijghijklmnopqrstuvwxyz}
\end{Highlighting}
\end{Shaded}
