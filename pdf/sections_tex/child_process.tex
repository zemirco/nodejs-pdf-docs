...
\texttt{child.stderr} is shorthand for \texttt{child.stdio{[}2{]}}. Both
properties will refer to the same object, or null.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{child = }\OtherTok{child_process}\NormalTok{.}\FunctionTok{spawn}\NormalTok{(}\StringTok{"ls"}\NormalTok{, \{}
    \DataTypeTok{stdio}\NormalTok{: [}
      \DecValTok{0}\NormalTok{, }\CommentTok{// use parents stdin for child}
      \StringTok{'pipe'}\NormalTok{, }\CommentTok{// pipe child's stdout to parent}
      \OtherTok{fs}\NormalTok{.}\FunctionTok{openSync}\NormalTok{(}\StringTok{"err.out"}\NormalTok{, }\StringTok{"w"}\NormalTok{) }\CommentTok{// direct child's stderr to a file}
    \NormalTok{]}
\NormalTok{\});}

\OtherTok{assert}\NormalTok{.}\FunctionTok{equal}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdio}\NormalTok{[}\DecValTok{0}\NormalTok{], }\KeywordTok{null}\NormalTok{);}
\OtherTok{assert}\NormalTok{.}\FunctionTok{equal}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdio}\NormalTok{[}\DecValTok{0}\NormalTok{], }\OtherTok{child}\NormalTok{.}\FunctionTok{stdin}\NormalTok{);}

\FunctionTok{assert}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdout}\NormalTok{);}
\OtherTok{assert}\NormalTok{.}\FunctionTok{equal}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdio}\NormalTok{[}\DecValTok{1}\NormalTok{], }\OtherTok{child}\NormalTok{.}\FunctionTok{stdout}\NormalTok{);}

\OtherTok{assert}\NormalTok{.}\FunctionTok{equal}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdio}\NormalTok{[}\DecValTok{2}\NormalTok{], }\KeywordTok{null}\NormalTok{);}
\OtherTok{assert}\NormalTok{.}\FunctionTok{equal}\NormalTok{(}\OtherTok{child}\NormalTok{.}\FunctionTok{stdio}\NormalTok{[}\DecValTok{2}\NormalTok{], }\OtherTok{child}\NormalTok{.}\FunctionTok{stderr}\NormalTok{);}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{options.stdio}\label{options.stdio}
