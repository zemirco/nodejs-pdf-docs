...
\KeywordTok{grep}\NormalTok{.}\FunctionTok{on}\NormalTok{(}\CharTok{'close'}\NormalTok{, }\KeywordTok{function} \NormalTok{(code, signal) \{}
...
\KeywordTok{process}\NormalTok{.}\FunctionTok{on}\NormalTok{(}\CharTok{'message'}\NormalTok{, }\KeywordTok{function}\NormalTok{(m, socket) \{}
  \KeywordTok{if} \NormalTok{(m === }\CharTok{'socket'}\NormalTok{) \{}
    \KeywordTok{socket}\NormalTok{.}\FunctionTok{end}\NormalTok{(}\CharTok{'You were handled as a '} \NormalTok{+ }\KeywordTok{process}\NormalTok{.}\FunctionTok{argv}\NormalTok{[}\DecValTok{2}\NormalTok{] + }\CharTok{' person'}\NormalTok{);}
  \NormalTok{\}}
\NormalTok{\});}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ls}\NormalTok{.}\FunctionTok{on}\NormalTok{(}\CharTok{'close'}\NormalTok{, }\KeywordTok{function} \NormalTok{(code) \{}
...
\KeywordTok{ps}\NormalTok{.}\FunctionTok{on}\NormalTok{(}\CharTok{'close'}\NormalTok{, }\KeywordTok{function} \NormalTok{(code) \{}
...
\KeywordTok{grep}\NormalTok{.}\FunctionTok{on}\NormalTok{(}\CharTok{'close'}\NormalTok{, }\KeywordTok{function} \NormalTok{(code) \{}
  \KeywordTok{if} \NormalTok{(code !== }\DecValTok{0}\NormalTok{) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var} \NormalTok{exec = require(}\CharTok{'child_process'}\NormalTok{).}\FunctionTok{exec}\NormalTok{,}
    \NormalTok{child;}
