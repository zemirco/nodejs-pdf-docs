...
\NormalTok{\{ }\CharTok{'content-length'}\NormalTok{: }\CharTok{'123'}\NormalTok{,}
  ...
  \CharTok{'host'}\NormalTok{: }\CharTok{'mysite.com'}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{[ }\CharTok{'ConTent-Length'}\NormalTok{, }\CharTok{'123456'}\NormalTok{,}
  \CharTok{'content-LENGTH'}\NormalTok{, }\CharTok{'123'}\NormalTok{,}
  \CharTok{'content-type'}\NormalTok{, }\CharTok{'text/plain'}\NormalTok{,}
  \CharTok{'CONNECTION'}\NormalTok{, }\CharTok{'keep-alive'}\NormalTok{,}
  \CharTok{'Host'}\NormalTok{, }\CharTok{'mysite.com'}\NormalTok{,}
  \CharTok{'accepT'}\NormalTok{, }\CharTok{'*/*'} \NormalTok{]}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{response}\NormalTok{.}\FunctionTok{statusMessage} \NormalTok{= }\CharTok{'Not found'}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{var} \NormalTok{options = \{}
  \DataTypeTok{hostname}\NormalTok{: }\CharTok{'www.google.com'}\NormalTok{,}
...
\hyperref[http_new_agent_options]{constructor options} below.) Then,
...
\hyperref[http_agent_destroy]{\texttt{destroy()}} KeepAlive agents
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{http}\NormalTok{.}\FunctionTok{get}\NormalTok{(\{}
  \DataTypeTok{hostname}\NormalTok{: }\CharTok{'localhost'}\NormalTok{,}
  \DataTypeTok{port}\NormalTok{: }\DecValTok{80}\NormalTok{,}
...
\subsubsection{new Agent({[}options{]})}
...
\KeywordTok{var} \NormalTok{keepAliveAgent = }\KeywordTok{new} \KeywordTok{http}\NormalTok{.}\FunctionTok{Agent}\NormalTok{(\{ }\DataTypeTok{keepAlive}\NormalTok{: }\KeywordTok{true} \NormalTok{\});}
\KeywordTok{keepAliveAgent}\NormalTok{.}\FunctionTok{request}\NormalTok{(options, onResponseCallback);}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{agent.maxFreeSockets}
...
\KeywordTok{proxy}\NormalTok{.}\FunctionTok{listen}\NormalTok{(}\DecValTok{1337}\NormalTok{, }\CharTok{'127.0.0.1'}\NormalTok{, }\KeywordTok{function}\NormalTok{() \{}
  ...
  \KeywordTok{var} \NormalTok{options = \{}
    ...
    \DataTypeTok{hostname}\NormalTok{: }\CharTok{'127.0.0.1'}\NormalTok{,}
...
\CommentTok{//   'ACCEPT',}
\CommentTok{//   '*/*' ]}
\KeywordTok{console}\NormalTok{.}\FunctionTok{log}\NormalTok{(}\KeywordTok{request}\NormalTok{.}\FunctionTok{rawHeaders}\NormalTok{);}
\end{Highlighting}
\end{Shaded}
